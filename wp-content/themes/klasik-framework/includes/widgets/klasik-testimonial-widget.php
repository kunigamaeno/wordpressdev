        ...
        if ( $customclass ) {
            $before_widget = str_replace('class="', 'class="'. $customclass . ' ', $before_widget);
					...
					if($text){
						...
						$output .='<div class="text-under-title testi-text">'.$text.'</div>';
					}	
					...
					$output .='<div class="klasik-testimonial-widget col'.$cols.'">';
						...
						$output .='<div class="row">';
							...
							if ($wp_query->have_posts()) : 
								...
								$cf_thumb = get_the_post_thumbnail($post->ID, 'klasik-widget-testimonial', array('class' => 'alignleft testi-img'));
