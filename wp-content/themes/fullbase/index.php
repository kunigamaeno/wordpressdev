 ...
 */
 get_header(); ?>
	...
	<main id="main" class="col-md-9" role="main">
		...
		<?php if ( is_search() ) { ?>
			<h1 class="huge"><?php esc_html_e('Result for:', 'fullbase'); ?> <strong><i><?php echo $s ?></i></strong></h1>
		<?php } else  if ( is_category() || is_tag() ) { ?>
			<h1 class="huge"><?php echo single_cat_title() ?></h1>
		<?php } else if ( is_home() ){ ?>
			<h1 class="huge"><?php single_post_title(); ?></h1>
		<?php } else if ( is_date() ){ ?>
			<h1 class="huge"><?php single_month_title(' '); ?> </h1>
		<?php } else if ( is_archive() ){ ?>
			<h1 class="huge"><?php post_type_archive_title(); ?> </h1>
		<?php } ?>
        ...
        <?php else : ?>
            ...
            <h3><?php esc_html_e('Sorry, no posts matched your criteria.', 'fullbase'); ?></h3>
            <p><?php esc_html_e('Try to make a search...', 'fullbase'); ?></p>
