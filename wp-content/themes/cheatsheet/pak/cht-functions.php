...
function cht_addhead()
{
    ...
    //$ret .=cht_csswrap( $te.get_where("tomorrow-night-eighties.css") );
    $ret .=cht_csswrap( $te.get_where("font-awesome.min.css") );
    $ret .=cht_csswrap( $te.get_where("bootstrap-github.min.css") );
    $ret .=cht_csswrap( $te.get_where("bootstrap-colorpicker.min.css") );
...
function cht_addscripts()
{
    ...
    wp_enqueue_script( 'cht-js2', $te.get_where('nprogress.min.js'),array( 'jquery' ),$ver1,true);
    ...
    wp_enqueue_script( 'cht-js4', $te.get_where('clipboard.min.js'),array( 'jquery' ),$ver1,true);
    wp_enqueue_script( 'cht-js100', $te.get_where('cht-foot.js'),array( 'jquery' ),$ver1,true);
